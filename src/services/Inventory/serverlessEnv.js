...
module.exports.databaseM = () => ({
  prod: {
    mongoURL:
      "mongodb+srv://bg97proyectos:nNqnI2iDGfoWD1z2@gb97.vfdyrvl.mongodb.net/gb97PuntoVentaProd?retryWrites=true&w=majority", // ingresar el valor url correcto para dev
  },
  dev: {
    mongoURL:
